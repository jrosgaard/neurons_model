"""
src/neurons_model/tests/sweep_test_0002.py
...
SWEEP_PATHWAYS = ("Ex->Ex", "In_fast->Ex", "In_adapt->Ex")

Ex_to_Ex_weights = (0.008, 0.010, 0.012, 0.014, 0.016)

In_fast_to_Ex_weights = (0.001, 0.002, 0.003, 0.004, 0.005, 0.006, 0.008, 0.010)
In_adapt_to_Ex_weights = (0.001, 0.002, 0.003, 0.004, 0.005, 0.006, 0.008, 0.010)

SWEEP_WEIGHTS = {
    "Ex->Ex": Ex_to_Ex_weights,
    "In_fast->Ex": In_fast_to_Ex_weights,
    "In_adapt->Ex": In_adapt_to_Ex_weights,
}
