"""
src/neurons_model/tests/sweep_test_0004.py
...
# Used for sweep 0005
#Ex_to_Ex_weights = (0.014286, 0.014796,0.015306, 0.017857)


# Sweep In->Ex weights, this includes both In_fast->Ex and In_adapt->Ex
# Default for both is 0.004
In_to_Ex_weights = np.linspace(0.000, 0.014, num=50)

# Used for sweep 0005
#In_to_Ex_weights = np.linspace(0.000, 0.014, num=10)


SWEEP_WEIGHTS = {
    "Ex->Ex": Ex_to_Ex_weights,
    "In_fast->Ex": In_to_Ex_weights,
    "In_adapt->Ex": In_to_Ex_weights,}
