"""
src/neurons_model/tests/sweep_test_0003.py
...
# Only sweep Ex->Ex weights, default is 0.012
Ex_to_Ex_weights = np.linspace(0.000, 0.025, num=50)  # 50 values from 0.000 to 0.025 inclusive

In_fast_to_Ex_weights = (0.004,)
In_adapt_to_Ex_weights = (0.004,)
